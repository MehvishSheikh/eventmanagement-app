...
const EventDisplay = ({ route }) => {
  ...
  const handleImagePress2 = (imageNumber) => {
    navigation.navigate('RsvpEventList', { imageNumber });
  };

  const handleImagePress1 = (imageNumber) => {
    navigation.navigate('EventDisplay', { imageNumber });
  };

  const handleImagePress3 = (imageNumber) => {
    navigation.navigate('CompletedEvents', { imageNumber });
  };
      ...
      <View style={[styles.container, { backgroundColor: isDarkMode ? '#000' : '#f8f8f8' }]}>
        <View style={styles.imageContainer}>
          ...
          <TouchableOpacity onPress={() => handleImagePress2()}>
            <Image
              source={isDarkMode ? require('../assets/image/rsvp1  (1).jpg') : require('../assets/image/rsvp1  (2).jpg')}
              style={styles.profileImage}
            />
          </TouchableOpacity>
